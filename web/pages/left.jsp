...
<dl class="leftmenu">
    ...
    <c:forEach items="${oneMenuList}" var="oneMenu">
        <dd>
            <div class="title"><span><img src="<%=basePath%>/images/leftico03.png"/></span>${oneMenu.oneName}</div>
            <ul class="menuson">
                <c:forEach items="${oneMenu.twoMenuList}" var="twoMenu">
                    <li>
                        <div class="header"><cite></cite>
                            <a href="<%=basePath%>/${twoMenu.url}" target="rightFrame">${twoMenu.twoName}</a> <i></i></div>
                    </li>
                </c:forEach>
            </ul>
        </dd>
    ...
    <dd>
        <div class="title"><span><img src="<%=basePath%>/images/leftico03.png"/></span><a
                href="suggestion/suggestion.html"
                target="rightFrame">客人意见</a></div>
    </dd>
</dl>
</body>
</html>
